...
-- ---------------- ORDERS (8) — status is now database-driven (no timers) + borrowed + payment audit ----------------
insert into public.orders (order_id, created_at, customer_name, phone, address, subtotal, delivery_fee, total, payment_method, schedule, notes, status, borrowed_count, is_borrowed, payment_status, is_canceled, is_delivered, is_paid, is_archived) values
('WFR-1234', '2026-09-11 09:30:00+08', 'Aling Nena Sari-Sari','0905-***-6789','Brgy. San Isidro - near market', 250, 0, 250, 'Cash on Delivery','Today',    'Partial hiram return included', 'DELIVERED',       0, false, 'PAID',   false, true,  true,  false),
('WFR-8761', '2026-09-10 14:00:00+08', 'Irosin NHS Canteen',  '0930-***-1111','San Julian, Irosin - Irosin NHS', 180, 0, 180, 'Cash on Delivery','Tomorrow', 'School event — need OR',        'DELIVERED',       4, true,  'PAID',   false, true,  true,  false),
('WFR-4821', now() - interval '2 hours', 'Juan Dela Cruz','0912-345-6789','Brgy. Monbon, Irosin - Purok 3 near chapel', 205, 0, 205, 'Cash on Delivery','Today','Leave at gate — dog is friendly', 'PENDING',         1, true,  'UNPAID', false,false,false,false),
('WFR-7392', now() - interval '3 hours', 'Maria Santos',  '0917-000-1122','Brgy. Patag, Irosin',                         105,0,105, 'Cash on Delivery','Today','',                                  'TO_PICK_UP',       0, false, 'UNPAID', false,false,false,false),
('WFR-6105', now() - interval '4 hours', 'Ana Reyes',     '0905-123-4567','Brgy. San Isidro, Irosin - San Isidro Elementary',85,0,85,'Cash on Delivery','Today','Leave at door',                   'GALLON_RECEIVED',   0, false, 'UNPAID', false,false,false,false),
('WFR-2847', now() - interval '5 hours', 'Kap. Reyes',    '0917-***-4321','Brgy. Patag - Barangay Hall',               355,0,355, 'Cash on Delivery','Tomorrow','Deliver before 10am — barangay meeting', 'OUT_FOR_DELIVERY',0, false, 'UNPAID', false,false,false,false),
('WFR-9153', now() - interval '6 hours', 'Mina Store',    '0920-***-9876','Brgy. Bagsangan - National Road',           125,0,125, 'Cash on Delivery','Today','',                                  'DELIVERED',       5, true,  'PAID',   false,true, true, false),
('WFR-5033', now() - interval '1 hour',  'Lito Manalo',   '0930-111-2222','Brgy. Carriedo, Irosin',                     60,0, 60, 'Cash on Delivery','Today','Customer requested cancel — wrong size', 'CANCELED',        0, false, 'UNPAID', true,false,false,false)
on conflict (order_id) do update set customer_name=excluded.customer_name, total=excluded.total, status=excluded.status, borrowed_count=excluded.borrowed_count, is_borrowed=excluded.is_borrowed, payment_status=excluded.payment_status, updated_at=now();
