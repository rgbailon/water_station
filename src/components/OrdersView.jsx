...
function Timeline({ order }) {
  ...
  return (
    <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
      ...
      {noPickup && <span style={{ fontSize: 10, color: '#92400e', background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 999, padding: '2px 6px', fontWeight: 700, marginLeft: 8 }}>Skips To Pick Up — New/Borrow → Preparing</span>}
    </div>
  )
}
